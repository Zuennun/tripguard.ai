        ...
        <div className="hero-left">
          <h1 style={{ fontFamily: "var(--font-head)", fontWeight: 900, fontSize: "clamp(2.4rem, 5vw, 4.2rem)", lineHeight: 1.08, letterSpacing: "-0.03em", color: "#0f2044", marginBottom: "1.25rem" }}>
            <span style={{ position: "relative", display: "inline-block" }}>
              ...
              <img src="/IconAir.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -14, left: "calc(100% - 8px)", width: 44, height: 44, borderRadius: 11, boxShadow: "0 6px 18px rgba(0,0,0,0.18)", transform: "rotate(-6deg)", animation: "iconPopA 0.5s cubic-bezier(0.34,1.56,0.64,1) 0s both, iconPulseA 3s ease-in-out 0.5s infinite" }} />
              <img src="/iconB (2).svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -10, left: "calc(100% + 38px)", width: 58, height: 58, borderRadius: 14, boxShadow: "0 8px 22px rgba(0,0,0,0.2)", transform: "rotate(7deg)", animation: "iconPopB 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.1s both, iconPulseB 3s ease-in-out 0.6s infinite" }} />
              <img src="/IconE.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -52, left: "calc(100% + 44px)", width: 36, height: 36, borderRadius: 9, boxShadow: "0 4px 14px rgba(0,0,0,0.15)", transform: "rotate(-10deg)", animation: "iconPopE 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.2s both, iconPulseE 3s ease-in-out 0.7s infinite" }} />
            </span>
            <br />
