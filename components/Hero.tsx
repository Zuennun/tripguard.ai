        ...
        <div className="hero-left">
          <h1 style={{ fontFamily: "var(--font-head)", fontWeight: 900, fontSize: "clamp(2.4rem, 5vw, 4.2rem)", lineHeight: 1.08, letterSpacing: "-0.03em", color: "#0f2044", marginBottom: "1.25rem" }}>
            <span style={{ position: "relative", display: "inline-block" }}>
              ...
              <img src="/iconB (2).svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -20, left: "calc(100% + 10px)", width: 108, height: 108, borderRadius: 26, boxShadow: "0 12px 36px rgba(0,0,0,0.22)", transform: "rotate(8deg)", animation: "iconPopB 0.5s cubic-bezier(0.34,1.56,0.64,1) 0s both, iconPulseB 3s ease-in-out 0.5s infinite" }} />
              <img src="/IconE.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -65, left: "calc(100% + 88px)", width: 88, height: 88, borderRadius: 22, boxShadow: "0 10px 28px rgba(0,0,0,0.18)", transform: "rotate(-10deg)", animation: "iconPopE 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.15s both, iconPulseE 3s ease-in-out 0.65s infinite" }} />
              <img src="/IconAir.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: 60, left: "calc(100% + 50px)", width: 80, height: 80, borderRadius: 20, boxShadow: "0 8px 24px rgba(0,0,0,0.15)", transform: "rotate(-6deg)", animation: "iconPopA 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.25s both, iconPulseA 3s ease-in-out 0.75s infinite" }} />
            </span>
            <br />
