        ...
        <div className="hero-left">
          <h1 style={{ fontFamily: "var(--font-head)", fontWeight: 900, fontSize: "clamp(2.4rem, 5vw, 4.2rem)", lineHeight: 1.08, letterSpacing: "-0.03em", color: "#0f2044", marginBottom: "1.25rem" }}>
            <span style={{ position: "relative", display: "inline-block" }}>
              ...
              <img src="/IconAir.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: 5, left: "calc(100% - 18px)", width: 29, height: 29, borderRadius: 7, boxShadow: "0 4px 12px rgba(0,0,0,0.18)", transform: "rotate(5deg)", animation: "iconPopA 0.5s cubic-bezier(0.34,1.56,0.64,1) 0s both, iconPulseA 3s ease-in-out 0.5s infinite" }} />
              <img src="/iconB (2).svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: 2, left: "calc(100% + 13px)", width: 31, height: 31, borderRadius: 8, boxShadow: "0 5px 14px rgba(0,0,0,0.2)", transform: "rotate(8deg)", animation: "iconPopB 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.1s both, iconPulseB 3s ease-in-out 0.6s infinite" }} />
              <img src="/IconE.svg" alt="" aria-hidden="true" className="hero-float-icon" style={{ position: "absolute", top: -22, left: "calc(100% + 8px)", width: 20, height: 20, borderRadius: 5, boxShadow: "0 3px 10px rgba(0,0,0,0.15)", transform: "rotate(-12deg)", animation: "iconPopE 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.2s both, iconPulseE 3s ease-in-out 0.7s infinite" }} />
            </span>
            <br />
